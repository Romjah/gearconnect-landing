...
export default async function Features() {
  ...
  const tracking = {
    ...
    features: [
      "Automatic lap time and performance capture (in development)",
    ...
    ctaText: "Join Alpha Development"
  };
  ...
  const community = {
    ...
    ctaText: "Help Build Community"
  };
  
  const cta = {
    title: "Ready to help shape the future of racing careers?",
    description: "Join our alpha community where we're building the platform that will automatically showcase track performances to teams, sponsors, and mentors looking for talent like yours.",
    buttonText: "Join Alpha Development"
  };
            ...
            <div className="flex">
              <div className="ml-3">
                <p className="text-sm text-yellow-800">
                  <strong>Alpha Community:</strong> Join the exclusive platform where racing performances get discovered by teams, sponsors, and mentors actively looking for new talent.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-indigo-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Our Alpha Vision</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We're building the future of racing career development. Join our alpha community to help shape a platform that gives talented pilots the visibility they deserve.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-lg text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Alpha Goal</h3>
              <p className="text-gray-600">Build the first platform that automatically showcases racing talent to industry professionals actively seeking new pilots.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg text-center">
              ...
              <p className="text-gray-600">Alpha members get exclusive early access to features and help shape the platform's development based on real pilot needs.</p>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Here's what we're building together during the alpha phase to create the future of racing career discovery
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">We'll develop systems to automatically capture and highlight your best racing performances</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Refine and scale the platform based on alpha feedback to help more pilots succeed</p>
            </div>
          </div>
        </div>
      </section>
